...
<body class="bg-light">
	...
	<div class="container mt-5">
		<div class="card shadow">
			...
			<div class="card-body">
				<form:form modelAttribute="board" action="update" enctype="multipart/form-data" name="f" class="needs-validation">
					<!-- 게시글 ID 및 게시판 ID (숨김 처리) -->
					...
					<div class="mb-3">
						...
						<c:if test="${!empty board.fileurl}">
							<div id="file_desc" class="mb-2">
								<a href="file/${board.fileurl}" class="me-2">${board.fileurl}</a>
