    ...
    <div class="container">
        ...
        <div class="card p-4">
                    ...
                    <tbody>
                        <c:forEach items="${sessionScope.CART.itemSetList}" var="itemSet" varStatus="stat">
                            <tr>
                                ...
                                <td class="text-end"><fmt:formatNumber value="${itemSet.item.price}" pattern="#,###"/> 원</td>
                                <td class="text-center"><fmt:formatNumber value="${itemSet.quantity}" pattern="#,###"/></td>
                                <td class="text-end"><fmt:formatNumber value="${itemSet.item.price * itemSet.quantity}" pattern="#,###"/> 원</td>
                            </tr>
                        </c:forEach>
                    </tbody>
                    <tfoot>
                        <tr>
                            <td colspan="4" class="text-end fw-bold">
                                총 구매 금액: <fmt:formatNumber value="${sessionScope.CART.total}" pattern="#,###"/> 원
                            </td>
                        </tr>
                    </tfoot>
                </table>
            ...
            <div class="d-flex justify-content-between mt-3">
                ...
                <a href="end" class="btn btn-success btn-custom" onclick="return confirm('주문을 확정하시겠습니까?');">
                    <i class="bi bi-check-circle"></i> 확정하기
                </a>
            </div>
        </div>
    </div>
