    ...
    <div class="col-md-8">
      <div class="card shadow">
        ...
        <div class="card-body">
          ...
          <form:form modelAttribute="item" action="update" method="post" enctype="multipart/form-data">
            <form:hidden path="id" />
            ...
            <div class="mb-3">
              ...
              <c:if test="${not empty item.pictureUrl}">
                <img id="preview" src="${pageContext.request.contextPath}/img/${item.pictureUrl}" alt="현재 이미지" />
              </c:if>
